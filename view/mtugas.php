                        ...
                        <div>
                            <div class="clearfix grpelem" id="u1469">
                                ...
                                <!--<div class="clearfix grpelem" id="j123" style="width:382px; heigth:32px">-->
                                    <input type="text" name="judul" placeholder="Nama File Jawaban">
                                <!--</div>-->
                            </div>
                        </div>
                    </div>
          <div class="clearfix colelem" id="pu1474">
                        ...
                        <div class="clearfix grpelem" id="u1474">
                            <!-- group -->
                        <input type="file" name="tugasquiz" class="grpelem" style="margin-top:5px; margin-left:3px;" id="u951-4" alt="tugas" width="87" height="17" /><!-- rasterized frame -->    
                        </div>
